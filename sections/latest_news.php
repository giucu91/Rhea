			...
			echo '<div class="container">';
				...
				echo '<div class="section-header">';
					...
					if( !empty($zerif_latestnews_title) ):
						...
						echo '<h2 class="dark-text">' . __('Latest news','rhea') . '</h2>';
						...
						if ( $zerif_latest_loop->have_posts() ) :
							...
							while ( $zerif_latest_loop->have_posts() ) : $zerif_latest_loop->the_post();
								...
								if ( !wp_is_mobile() ){
										...
										else if($i_latest_posts % 3 == 1){
											echo $newSlide;
										}
									
										echo '<div class="col-xs-12 col-sm-4 col-md-4 latestnews-box">';
											...
											echo '<div class="latestnews-img">';
												...
												echo '<a class="latestnews-img-a" href="'.esc_url( get_permalink() ).'" title="'.esc_attr( get_the_title() ).'">';
													...
													if ( has_post_thumbnail() ) :
														...
														echo '<img src="'.esc_url( get_template_directory_uri() ).'/images/blank-latestposts.png" class="demo-image" alt="'.esc_attr( get_the_title() ).'" />';
													endif; 
											...
											echo '<div class="latesnews-content">';
												...
												if($ismore) {
													the_content( sprintf( esc_html__('[...]','rhea'), '<span class="screen-reader-text">'.esc_html__('about ', 'rhea').get_the_title().'</span>' ) );
												} else {
													the_excerpt();
												}
